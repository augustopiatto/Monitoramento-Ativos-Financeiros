...
class PriceFunnel(models.Model):
    ...
    user_id = models.ForeignKey("User", related_name="funnels", on_delete=models.CASCADE)
...
class Asset(models.Model):
    ...
    price_funnel_id = models.ForeignKey("PriceFunnel", related_name="assets", on_delete=models.CASCADE, null=True)
